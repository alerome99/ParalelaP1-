...
int main(int argc, char *argv[]) {
	double tiempoTotalBucle1;
	double tiempoTotalBucle2;
	double tiempoTotalBucle3;
	double tiempoTotalBucle4;
	double tiempoTotalBucle5;
	double tiempoTotalBucle6;
	double tiempoTotalBucle7;
	double tiempoTotalBucle8;
	double tiempoTotalBucle9;
	double tiempoTotalBucle10;
	double tiempoBucle1;
	double tiempoBucle2;
	double tiempoBucle3;
	double tiempoBucle4;
 ...
 */
	...
	printf("Inicialización 1 3: %f", tiempoTotalBucle1);
	printf("\n");
	printf("Inicialización 2 3: %f", tiempoTotalBucle2);
	printf("\n");
	printf("Tirar nueva comida 4.1: %f", tiempoTotalBucle9);
	printf("\n");
	printf("Preparar estructuras 4.2: %f", tiempoTotalBucle10);
	printf("\n");
	printf("Movimiento celulas 4.3: %f", tiempoTotalBucle3);
	printf("\n");
	printf("Accion celulas 4.4: %f", tiempoTotalBucle4);
	printf("\n");
	printf("Limpieza comida consumida 4.5: %f", tiempoTotalBucle5);
	printf("\n");
	printf("Limpieza celulas muertas 4.6: %f", tiempoTotalBucle6);
	printf("\n");
	printf("Nuevas celulas 4.7: %f", tiempoTotalBucle7);
	printf("\n");
	printf("Decremento comida que no se consume 4.8: %f", tiempoTotalBucle8);
	printf("\n");
